...
INSERT INTO `account` VALUES (24,'Business','Nepal'),(25,'Loan','Nepal');
...
INSERT INTO `user` VALUES (15,'rock'),(16,'hhh');
...
CREATE TABLE `user_account` (
  ...
  KEY `account_fkey_idx` (`account_id`),
  CONSTRAINT `account_fkey` FOREIGN KEY (`account_id`) REFERENCES `account` (`accountId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `user_account` VALUES (1,24,15),(2,25,15),(3,24,16),(4,25,16);
...
-- Dump completed on 2016-05-06 17:32:04
